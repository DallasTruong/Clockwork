class Test extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("painter_tiles", "FullSheet.png");    // tile sheet
        this.load.tilemapTiledJSON("paintermap", "Map1.json");    // Tiled JSON file
    }
    ...
    create() {
        ...
        this.tileset = this.map.addTilesetImage("FullSheet", "painter_tiles");
